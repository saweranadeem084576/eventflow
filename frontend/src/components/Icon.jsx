// Minimal Feather-style icon set (24px viewBox, stroke-based).
const paths = {
  calendar: 'M3 5h18v16H3zM16 3v4M8 3v4M3 11h18',
  pin: 'M12 22s7-7.1 7-12a7 7 0 1 0-14 0c0 4.9 7 12 7 12zM12 12.5a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5z',
  users:
  ...
  ticket:
    'M2 9V7a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v2a2 2 0 0 0 0 4v2a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2v-2a2 2 0 0 0 0-4zM13 5v14',
